function DashBoard() {
  return (
    <div className="border-b border-gray-200 dark:border-gray-700 max-w-md">
      ...
      <p>
        English App: This project has the purpose of creating a foreign language
        learning app that connects natives with learners
      </p>
    </div>
  );
}
